...
class LoginController extends Controller
{
    ...
    */
    ...
    {
        if($request->input('submit') == 'magiclink'){
            ...
            return redirect()->route('login')->withMessage( 'An email has been sent, please check your email address')->withInput();
        }
    ...
    public function loginViaMagicLink(Request $request){
        ...
        if($user){
            $user->notify(new LoginViaMagicLink());
        }
        return $user;
