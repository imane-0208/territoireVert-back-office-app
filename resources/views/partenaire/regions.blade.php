    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-header"><h1>Rgions</h1></div>
                ...
                <div class="card-body">
                    ...
                    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ route('addRegionToPartner')}}" method="POST">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <form class="" action="{{ route('deletePartenaireRegion')}}" method="POST">
                                        {!! csrf_field() !!}
                                        <input type="hidden" class="form-control" value="{{ $partenaire->id }}" id="nompartenaire" name="partenaireId">
                                        <input type="hidden" class="form-control" value="{{ $region->id }}" id="nompartenaire" name="regionId">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="{{ url('categorie')}}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    {!! csrf_field() !!}
                                                  <label for="nomRegion" class="form-label">Nom categorie</label>
